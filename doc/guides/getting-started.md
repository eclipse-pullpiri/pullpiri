...
There is a `settings.yaml` for configuration. This is automatically generated in `/etc/pullpiri/settings.yaml` during installation.

```yaml
yaml_storage: /etc/pullpiri/yaml
pullpiri_cloud: http://0.0.0.0:41234
host:
  name: HPC
  ip: 0.0.0.0
  type: bluechi
...
- pullpiri_cloud : The repository address saving `Packages` and `scenarios`.
...
fd03b211e2ac  gcr.io/etcd-development/etcd:v3.5.24  --data-dir=/etcd-...  32 seconds ago  Up 32 seconds  2379-2380/tcp  pullpiri-server-etcd
c6fbbb6feca5  localhost/pullpiri-server:latest                            32 seconds ago  Up 31 seconds                 pullpiri-server-apiserver
341edada2c33  localhost/pullpiri-agent:latest                             31 seconds ago  Up 31 seconds                 pullpiri-agent-nodeagent
eee2153bb581  localhost/pullpiri-player:latest                            31 seconds ago  Up 30 seconds                 pullpiri-player-filtergateway
8d8011a24b43  localhost/pullpiri-player:latest                            31 seconds ago  Up 30 seconds                 pullpiri-player-actioncontroller

[root@master images]# podman pod ps
POD ID        NAME            STATUS      CREATED             INFRA ID      # OF CONTAINERS
cc169812bd3e  pullpiri-player  Degraded    About a minute ago  fb8974d9ba47  4
85eeff5e07cf  pullpiri-agent   Running     About a minute ago  518c9482ae00  2
809508bfdc46  pullpiri-server  Degraded    About a minute ago  1a738d6106f0  5
```
